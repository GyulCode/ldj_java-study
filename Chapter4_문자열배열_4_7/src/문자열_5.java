//분리
/*
 *    문자열 추출 : substring() - lastIndexOf(), indexOf()
 *    문자열 분리 : split()
 *    문자열 변경 : replace(), replaceAll()
 *    
 */
public class 문자열_5 {
...
/*		String s="Hello Java!!";
		...
		String s=addr.substring(0,addr.lastIndexOf("지번")); //***lastIndexof() 끝나는 문자의 위치 반환
		System.out.println(s);
		String ss=addr.substring(0,addr.lastIndexOf("서울"));
		System.out.println(ss);
		/*
		 *    인덱스가 있는 위치값
		 *    lastIndexOf() // 뒤에서부터 찾아오는 방법
		 *    indexOf()     // 앞에서부터 찾아오는 방법
		 */
		String str="Hello Java!!";
		String sss=str.replace("a", "b");
		System.out.println(sss);
		String sss1=str.replace("Java","Oralce"); //대소문자 구분함ㅎㅎ
